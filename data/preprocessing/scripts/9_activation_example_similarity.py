...
def lazy_import_dependencies():
    ...
    global sentence_transformers, spacy
...
class ActivationSimilarityProcessor:
    ...
    def _load_models(self):
        """Load ML models (sentence-transformers and spaCy)."""
    ...
    def _compute_pairwise_semantic_similarity(self, examples: List[Tuple]) -> Optional[float]:
        """Compute average pairwise cosine similarity for 32-token windows.
    ...
    def process_feature(self, feature_id: int, feature_df: pl.DataFrame) -> Dict[str, Any]:
        ...
        # Compute metrics
        semantic_sim = self._compute_pairwise_semantic_similarity(examples)
